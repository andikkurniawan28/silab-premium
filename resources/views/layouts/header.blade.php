<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
        <form class="search-form d-flex align-items-center" method="POST" action="{{ route("changeDate") }}">
            @csrf
            <input type="date" name="date" value="{{ session("date") }}" onchange="this.form.submit()" required>
